# Spanish Oral – Picture Description (Maths Lesson)

**Student:** Shrishti · **Year 8 · St Paul's Girls School**
**Task:** ~2 minutes spoken description of a picture, in the first person.

---

## 🎨 La Imagen / The Picture

A bright classroom with children working in a maths lesson: some are drawing shapes, some are doing sums at round tables, two children sit on the floor playing with big foam numbers (5, 6, =, ×), there is a clock, a globe, an abacus, a plant, and three pictures on the wall (an apple, a rainbow, and a stick-figure person with a dog).
...
## 🗝️ Useful Vocabulary / Vocabulario Clave

| Español | English |
|---|---|
| el aula / la clase | the classroom |
| la lección de matemáticas | the maths lesson |
| la mesa redonda | the round table |
| el cuaderno | the notebook |
| el rotulador | the marker pen |
| las formas geométricas | geometric shapes |
| el triángulo / el cuadrado / el círculo | triangle / square / circle |
| el suelo | the floor |
| la pared | the wall |
| el reloj | the clock |
| el globo terráqueo | the globe |
| el ábaco | the abacus |
| la planta | the plant |
| el dibujo | the drawing / picture |
...
| ayudar | to help |
| sonreír | to smile |
| estoy orgullosa | I am proud (feminine) |
